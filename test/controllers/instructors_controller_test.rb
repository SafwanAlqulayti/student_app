...
class InstructorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create instructor" do
    assert_difference('Instructor.count') do
      post instructors_url, params: { instructor: { integer: @instructor.integer, name: @instructor.name, number_of_courses: @instructor.number_of_courses } }
    end
  ...
  test "should update instructor" do
    patch instructor_url(@instructor), params: { instructor: { integer: @instructor.integer, name: @instructor.name, number_of_courses: @instructor.number_of_courses } }
